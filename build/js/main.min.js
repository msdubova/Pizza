...
function setTab() {
  ...
  var tabControls = tab.querySelectorAll('.tabs__control');
  var tabCards = tab.querySelectorAll('.tabs__card');
  function clearTab() {
  ...
  function changeTab(item) {
    ...
    var tabId = currentControl.getAttribute('data-tab');
    var currentCards = tab.querySelectorAll(tabId);
    if (tabId === '#all') {
...
function setAccordeon(elements, number) {
  var tab = document.querySelector('.tabs');
  var btn = tab.querySelector('.tabs__more');
  ...
  if (elements.length > number) {
    ...
    for (var i = elements.length; i > number; i--) {
...
// }
var buttonMores = document.querySelectorAll('.btn--more');
buttonMores.forEach(function (element) {
  element.addEventListener('click', function () {
    var card = element.closest('li');
    var heading = card.querySelector('h3').innerHTML;
    var image = card.querySelector('picture').innerHTML;
    var text = card.querySelector('p').innerHTML;
    var modal = document.querySelector('.modal__description');
